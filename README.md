...
The intention of this component is to provide a more linear progression of the ApR and damage/THAC0 while not going quite as nuts as other mods do with it. All classes receive full bonuses (including ApR) from the weapon profiencies listed below so long as they can attain said weapon proficencies, while fighter-types exclusively receive an additional 0.5 ApR bonus at 7th level and 13th level. At Grandmastery (5 stars), a 13th level fighter will have a total of 3.5 ApR - Mastery would instead be 3.0. A non-fighter at Mastery (3 stars) would instead have 2.0 ApR, receiving the +1 ApR bonus from Mastery but not the exclusive fighter-type ApR ApR bonus.<br/>
